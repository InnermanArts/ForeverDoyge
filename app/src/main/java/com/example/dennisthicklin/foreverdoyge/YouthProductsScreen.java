...
public class YouthProductsScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabaseReference = database.getReference("Youth");
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(YouthProductsScreen.this, MainActivity.class);
                startActivity(i);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    ...
                    case R.id.open_to_individual:
                        Intent intent = new Intent(YouthProductsScreen.this, OpenToIndividual.class);
                        startActivity(intent);
                        break;
                    case R.id.contact:
                        Intent ix = new Intent(YouthProductsScreen.this, Contact.class);
                        startActivity(ix);
                        break;
                }
                ...
                new FirebaseRecyclerAdapter<ModelClass, LuxeProductsScreen.ProductViewHolder>(
                    ...
                    protected void populateViewHolder(LuxeProductsScreen.ProductViewHolder viewHolder, final ModelClass model, int position){
                        ...
                        viewHolder.myView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(YouthProductsScreen.this, ProductScreen.class);
