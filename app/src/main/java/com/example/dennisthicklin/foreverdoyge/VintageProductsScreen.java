...
public class VintageProductsScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDatabaseReference = database.getReference("Vintage");
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(VintageProductsScreen.this, MainActivity.class);
                startActivity(i);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    ...
                    case R.id.open_to_individual:
                        Intent intent = new Intent(VintageProductsScreen.this, OpenToIndividual.class);
                        startActivity(intent);
                        break;
                    case R.id.contact:
                        Intent ix = new Intent(VintageProductsScreen.this, Contact.class);
                        startActivity(ix);
                        break;
                }
                        ...
                        viewHolder.myView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                if(model.getImage().contains("skirt")){
                                    Intent intent = new Intent(VintageProductsScreen.this, SkirtProduct.class);
                                    intent.putExtra("image", model.getImage());
                                    startActivity(intent);
                                }else if(model.getImage().contains("dashiki")){
                                    Intent intent = new Intent(VintageProductsScreen.this, DashikiProduct.class);
                                    intent.putExtra("image", model.getImage());
                                    startActivity(intent);
                                }else{
                                    Intent intent = new Intent(VintageProductsScreen.this, ProductScreen.class);
                                    intent.putExtra("image", model.getImage());
                                    startActivity(intent);
                                }
                            }
